...
// Lazy-load the heavy animated map
const TacticalWorldMap = dynamic(() => import("./TacticalWorldMap"), {
  ssr: false,
  loading: () => (
    <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #020d1a 0%, #030f1f 100%)" }} />
  ),
});
...
export default function HeroMapSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      {/* Full-screen tactical world map */}
      <TacticalWorldMap />

      {/* Gradient overlay — ensures text readability */}
      <div className="absolute inset-0 z-[1] pointer-events-none"
        style={{ background: "linear-gradient(90deg, rgba(2,13,26,0.85) 0%, rgba(2,13,26,0.6) 50%, rgba(2,13,26,0.3) 100%)" }} />
      ...
      {/* Content — left-aligned over the map */}
